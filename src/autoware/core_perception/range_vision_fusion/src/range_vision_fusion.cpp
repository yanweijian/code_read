...
{
  // 将激光雷达检测得到的目标分组，分为摄像头可见区域内和摄像头可见区域外
  // 摄像头可见区域内的激光雷达目标才能进行融合
